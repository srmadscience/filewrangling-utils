 ...
 */
public class FieldPrependOptionalTest {

    @org.junit.jupiter.api.Test
    void fixFieldNull() {

        FieldPrepend fieldToTest = new FieldPrepend("N",true);
    ...
    void fixFieldNotMull() {
        ...
        FieldPrepend fieldToTest = new FieldPrepend(StringToPrepend,true);
    ...
    @org.junit.jupiter.api.Test
    void fixFieldNotNullIsMissingYes() {
    ...
    @org.junit.jupiter.api.Test
    void fixFieldNotNullIsMissingNo() {

        final String StringToPrepend = "N";
        final String payload = StringToPrepend + "1976T";
    ...
    @org.junit.jupiter.api.Test
    void fixFieldNotMullWRYesIfMissing() {
    ...
    @org.junit.jupiter.api.Test
    void fixFieldNotMullWRNoIfMissing() {
