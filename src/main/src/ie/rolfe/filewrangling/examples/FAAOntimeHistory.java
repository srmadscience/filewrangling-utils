...
public class FAAOntimeHistory extends BaseFileWrangler {
    public FAAOntimeHistory(File inputFile, File outputFile) {
        ...
        wantedFields.useForFields("OP_UNIQUE_CARRIER,TAIL_NUM,OP_CARRIER_FL_NUM,ORIGIN,ORIGIN_CITY_NAME,DEST,DEST_CITY_NAME,CRS_DEP_TIME,DEP_TIME,DEP_DELAY,CRS_ARR_TIME,CRS_ELAPSED_TIME,DISTANCE");
